...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0, _vendor.runTrainersSlider)();
  (0, _vendor.runReviewSlider)();
  ...
  var video = document.querySelector('.about__button');
  ...
  video.addEventListener('click', function () {
    ...
    var src = aboutVideo.dataset.src;
...
},{"./modules/accordion/accordions":2,"./modules/accordion/index":3,"./modules/accordion/init-accordion":4,"./modules/form-validate/form":6,"./modules/tabs/index":12,"./modules/tabs/init-tabs":13,"./modules/tabs/tabs":14,"./utils/ios-vh-fix":16,"./vendor":17}],2:[function(require,module,exports){
"use strict";
...
var Message = /*#__PURE__*/function () {
  ...
  _createClass(Message, [{
    ...
    value: function _messageTemplate(message, state) {
      ...
      return "<span class=\"input-message form__input-error ".concat(cssClass, "\">").concat(message, "</span>");
    }
  }, {
    key: "removeMessage",
...
exports.runTrainersSlider = exports.runReviewSlider = void 0;
require("./vendor/swiper");
require("./vendor/focus-visible-polyfill");
// Swiper 7.4.1

var trainerSlider = document.querySelector('.trainers__wrapper');
var reviewSlider = document.querySelector('.swiper-reviews');
var runTrainersSlider = function runTrainersSlider() {
  if (trainerSlider) {
    var swiper = new Swiper(trainerSlider, {
      // Optional parameters
...
exports.runTrainersSlider = runTrainersSlider;
var runReviewSlider = function runReviewSlider() {
  if (reviewSlider) {
...
exports.runReviewSlider = runReviewSlider;

},{"./vendor/focus-visible-polyfill":18,"./vendor/swiper":19}],18:[function(require,module,exports){
"use strict";
